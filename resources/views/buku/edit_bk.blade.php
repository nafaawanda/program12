...
<form action="/bk/update/{{$bk->kode_buku}}" method="POST">
    ...
    <input type="text" name="nama_penulis" placeholder="Masukan Nama Penulis" class="form-control" value="{{$bk->nama_penulis ?? ''}}"><br>
    <input type="text" name="jenis_buku" placeholder="Masukan Jenis Buku" class="form-control" value="{{$bk->jenis_buku ?? ''}}"><br>
    ...
    <input type="text" name="kode_rak" placeholder="Masukan Kode Rak" class="form-control" value="{{$bk->kode_rak ?? ''}}"><br>
